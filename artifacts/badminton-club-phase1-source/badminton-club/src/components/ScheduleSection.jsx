    ...
    <div className="animate-fade-in">
      ...
      <div className="mt-10 p-4 bg-primary-900/5 rounded-2xl border border-primary-200/30">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-5 gap-2 text-xs">
          {[
            { week: '第1周 07-02', coaches: '孙刚、齐文泉、姜波', rest: '刘嵩、刘浩龙' },
            { week: '第2周 07-09', coaches: '姜波、刘嵩、刘浩龙', rest: '孙刚、齐文泉' },
            { week: '第3周 07-16', coaches: '刘浩龙、孙刚、齐文泉', rest: '姜波、刘嵩' },
            { week: '第4周 07-23', coaches: '齐文泉、姜波、刘嵩', rest: '刘浩龙、孙刚' },
            { week: '第5周 07-30', coaches: '刘嵩、刘浩龙、孙刚', rest: '齐文泉、姜波' },
          ].map(r => (
